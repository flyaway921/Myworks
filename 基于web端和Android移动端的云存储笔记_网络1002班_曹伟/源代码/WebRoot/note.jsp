...
<body>
  ...
  <div  id="content" >
    <center>
      <form id="form1" name="form1"  method="post" action="aboutnote!addnote?page=1" onsubmit="return validate_note();" style=" background:url(images/2012052412255329-900.jpg)">
        <table width="692" height="529" border="0">
          <tr>
            <td height="34" valign="bottom">
             <center>
               <input name="title" class="note_title" type="text" id="textfield"  size="30" placeholder="请输入标题" />
             </center>
          ...
          <tr>
            <td height="209">
              <center><textarea name="content" id="textarea2" class="note_text" ></textarea></center>
            </td>
          </tr>
          <tr>
